...
/**
 *  This command starts the extra sequencer.
 *  Start the extra sequencer and write the start block number and the end block number.
 *  
                                         ...
                                         uint16_t i_u16_end_block_number)
{
    ...
    /* Set local variables */
    l_u16_flwl_value = i_u16_start_block_number & R_RFD_VALUE_U16_MASK1_FSW_BLOCK_INFO;
    l_u16_flwh_value = i_u16_end_block_number & R_RFD_VALUE_U16_MASK1_FSW_BLOCK_INFO;
